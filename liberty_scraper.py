...
def scrape(url='http://digitalcommons.liberty.edu/honors/615/'):
    ...
    if any([
        ...
        bepress_scraped_data = scrape_bepress(url)
        if bepress_scraped_data:
            scraped_urls.add(url)
        return bepress_scraped_data
    ...
    if not any([
                ...
                url.startswith('http://digitalcommons.liberty.edu/gov_fac_pubs'),
                ...
                url.startswith('http://digitalcommons.liberty.edu/lts_fac_pubs'),
